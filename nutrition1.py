...
if 'health_profile' not in st.session_state:
    st.session_state.health_profile = {
        'goals': 'Lose 5kg in 1 month\nImprove Heart health',
        'conditions': 'High BP',
        'routines': '15 Minutes Of Excersie Daily',
...
st.warning("🚨 This app provides AI-generated guidance and is not a substitute for professional medical advice.")
    ...
    if st.button("Generate Personalized Meal Plan"):
        ...
        if not any(st.session_state.health_profile.values()):
            ...
            with st.spinner("Creating your personalized meal plan..."):
                ...
                Create a structured 7-day personalized meal plan based on the user's profile below:
                ...
                1. Provide a complete 7-day meal plan.
                ...
                - Evening snack
                - Dinner
                3. Mention estimated calories and protein for each meal.
                4. Provide total daily calories and protein.
                5. Briefly explain why the meals align with the user's goals.
                6. Ensure meals strictly follow dietary restrictions and medical conditions.
                7. Keep meals practical, realistic, and easy to prepare.

                After the 7-day plan, include:
                - Weekly average calories and protein
                - A categorized shopping list
                - 3–5 meal prep or time-saving tips

                Format the response clearly using headings, bullet points, and day-wise sections.
    ...
    if uploaded_file is not None:
        ...
        if st.button("Analyze Food"):
            with st.spinner("Analyzing your food..."):
                ...
                prompt = f"""
                You are a certified nutritionist analyzing a food image.

                Carefully examine the image and identify all visible food items.
                ...
                - Key micronutrients (if identifiable)
                - Potential health benefits
                - Possible dietary concerns (e.g., high sodium, sugar, allergens)

                Then provide:
                - Total estimated calories for the full meal
                - Overall nutritional assessment (balanced, high-protein, high-fat, etc.)
                - 1–2 practical improvement suggestions if needed

                Keep estimates realistic.
                Avoid extreme assumptions.
                Present the answer clearly with headings and bullet points.
                """
    ...
    if st.button("Get Expert Insights"):
        ...
        if not health_query:
            ...
            with st.spinner("Researching your question..."):
                ...
                prompt = f"""
                You are a certified nutritionist and evidence-based health advisor.
                ...
                Routine: {st.session_state.health_profile['routines']}
                Preferences: {st.session_state.health_profile['preferences']}
                Restrictions: {st.session_state.health_profile['restrictions']}

                Provide:

                1. A clear explanation of the topic (based on current nutritional science)
                2. How it relates to the user's health profile
                3. Practical and realistic recommendations
                4. Precautions or contraindications (if relevant)
                5. Suggested foods or lifestyle adjustments

                Keep the language simple but medically accurate.
